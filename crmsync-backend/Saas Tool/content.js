...
(function() {
    ...
    try {
      ...
      panel.innerHTML = `
        <div class="upgrade-overlay">
          ...
          <div class="upgrade-subtitle">You're at ${limitInfo.count}/${limitInfo.limit} contacts</div>
          ...
          <div class="upgrade-message">
            Upgrade to <strong>Pro</strong> to approve this contact and unlock <strong>1,000 contacts</strong>
          </div>
          
          <div class="upgrade-actions">
            <button class="btn-upgrade-now">✨ Upgrade to Pro</button>
            <button class="btn-upgrade-dismiss">Maybe Later</button>
          </div>
          
          <div class="upgrade-note">
            Or delete some contacts to free up space
          </div>
        </div>
      `;
  ...
  async function showApprovalPanel(contact, messageContainer) {
    try {
      ...
      // If at limit, show upgrade panel instead
      if (limitInfo.success && !limitInfo.canAdd) {
